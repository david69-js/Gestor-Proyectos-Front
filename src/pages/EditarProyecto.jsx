        ...
        <form className="form-crear-proyecto styled-form custom-editarProyecto" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <CKEditor
              ...
              config={{
                licenseKey:
                  'eyJhbGciOiJFUzI1NiJ9..SmfmK72afO2bE04NzkU2i2XltlHwJ1v6UcAz65Ezom4Tn4Xm_gV7-QsBoA6pcVQhd7gqRjxon5Y_57S4kq_mkQ',
                toolbar: [
                  'heading',
                  '|',
                  'bold',
